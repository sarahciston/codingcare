...
<!-- Cinematic arts professor and critic Holly Willis argues, "arts-based research is rooted in critical theory, framing the research process within the context of power, emancipation and a deep questioning of the ethical and ideological implications of knowledge and change" [@willisFastForwardFuture2016].  -->
<!-- keep or cut or move??? -->

For me, artistic research has the capacity to combine rigorous scholarly investigation, deep community building and activism, and creative play in ways that facilitate connections across broader non-academic audiences. 
...
## [TRANS: *Crafting Queer Trans\*formative Systems, a Theory in Process*](https://coding.care/transform.html)
...
- MacKenzie, A. (2017). *Machine Learners.*
...
- Reddy, A. (2023, July 13). Reading AI Family Resemblances using Cross-Stitch Patterns. Formy. https://formy.xyz/en/artykul/reading-ai-family-resemblances-using-cross-stitch-patterns/
...
<!-- ![Freddie Mercury](assets/img/freddie-dance.png) -->
![Queen, "Don't Stop Me Now"](assets/img/freddie-dontstop.png)
...
[^databases]: Relational databases (like SQLite) are one way to structure stored data that puts information in tables. It describes the relationships pieces of info have to each other through its fixed structures, which are established before the information is entered. For example, an address book of an extended family might include a table that lists people and their home addresses. It might include a second table that shows houses and the people who live in each house. These tables could be cross-referenced by ID numbers given to each person and address. So, the information is stored in multiple tables in based on its relationship to other information. This can be very useful, but also very brittle, which has led to unstructured non-relational databases. These have their own pros and cons, too. For some facinating reflections on how database structures shape the way we see information, see Tara McPherson's *Feminist in a Software Lab*, in which she describes developing more flexible structures for scholars working with unconventional data [@mcphersonFeministSoftwareLab2018].
...
![](assets/img/ofmd-vulnerable.png)
...
The same is true of the digital spaces we create. The open-source software community P5.js took an active approach to access when they declared in 2019 that they would only build in new features to their software that supported increased access, broadly construed. They have included increasing support for translation, assistive tech, friendly error messages and contributor resources, and mentorship of historically excluded communities all under this umbrella of their [Focus on Access](https://github.com/processing/p5.js/blob/main/contributor_docs/access.md). More resources on digital accessibility were highlighted during [p5 Access Day 2022](https://p5js.org/community/p5js-access-day-2022.html). Simple things you can do for digital accessibility include making sure your website and newsletter include [image descriptions](https://uxdesign.cc/how-to-write-an-image-description-2f30d3bf5546) and follow best practices for [web accessibility](https://www.w3.org/WAI/tips/), including in your interface design, content, and development [@chenHowWriteImage2021; @initiativewaiTipsGettingStarted2024; @P5JsContributor_docsa].
...
![](assets/img/ofmd-fanfiction.png)
...
Snacks are rivaled only by music and movement in the essentials for our meetups. At our first gathering, we began a collaborative playlist that always kicks off with Queen's "Don't Stop Me Now." This track became our theme song at our very first meetup, when I asked if folks would like background music while we worked, and an otherwise very quiet student piped up out of the blue with this amazing suggestion. Perhaps it seems out of character as a rallying cry for a room full of people typing on computers, but I argue that it speaks to a Code Collective mindset that finds joy in doing the impossible:
...
<!-- ![Freddie](assets/img/freddie.png) -->
...
><footer>–Kit Braybrooke, creator of "COVID Creatives Toolkit" [-@braybrookeTogetherWeDance2020]</footer>
...
>"In the same way big oil brands itself with greenwashing for illusory environmental progressiveness, big tech extol their open source efforts to open-wash their capitalist, monopolistic, and destructive reality. Technological development is in dire need for a policy-first, documentation-first, ideology-first methodology, and AI must transform its focus on creating systems which understands and addresses the complexity of its environment, critically assesses its context, and produces meaning-rich results." 
><footer>–Elea Zhong, "Llama Chained: A Critical Assesment in Open Source AI" (2023)</footer>

<!-- Machine unlearning ([ender 2023](https://www.enderverse.org/notes/unlearning.html)) points out that 
The new task in machine learning called 'machine unlearning' has emerged due to large models' training costs and the practice of indiscrimine data scraping. As Code Collective member ender writes, machine unlearning assumes access to the models it wants to alter, which also assumes a powerful role with agency in big tech. Instead, ender combines questions of machine unlearning with adversarial data poisoning to ask how one can remove data from a model without access to the initial model.  -->

When choosing a tool to use, you might ask: 
...
><footer>[@goldingDataLoam2020]</footer>
...
#  
<!-- Codes for (Un)Knowing #### Codes for Essaying, Codes for Risking, Codes for Losing -->
...
<!-- machine hallucination, black boxes and race, the color of this whiteness, the exclusion/erasure of this blackness -->
<!-- >"Blackness as counterpuntal and primordial to the whiteness of the screen" [@artistBlackGooeyUniverse] -->
...
<!-- What does this black box have to do with the white [room/cube] we are in? Its white refrigerator glow hat hums at a frequency I can feel in the bones of my skull. -->

<!-- Continually feeding the black box feels like standing in the white glow of the refrigerator cube past midnight even though I'm stuffed.  -->

<!-- I outsource analysis to the mawing void. I put my body in the shame space. -->
...
![Sarah Ciston, "e-face," 2015](assets/img/lips.jpg) 
...
<!-- >"Creating a hallucination image may not be appropriate or beneficial for understanding the condition. However, I can provide a description of some common hallucinations experienced by individuals with Lewy body dementia: Imagine a scene where reality blurs with fantasy, where everyday objects and shadows seem to transform into something else entirely. In the mind of someone with Lewy body dementia, hallucinations can manifest as vivid and often unsettling experiences. Picture a living room bathed in the soft glow of evening light. A chair in the corner seems to subtly shift and contort, taking on the appearance of a looming figure or a face staring back with hollow eyes. Shadows dance on the walls, morphing into familiar shapes that twist and distort before fading away. In the kitchen, mundane sounds become eerie whispers, and ordinary objects take on a life of their own. A teapot may appear to sprout legs and scuttle across the counter, or a loaf of bread might transform into a writhing mass of snakes before dissolving into thin air. These hallucinations can be terrifying and disorienting for those experiencing them, blurring the lines between reality and imagination in a way that is both bewildering and distressing." -->

<!-- I ask again but ask for a good hallucination: -->

<!-- >"A vase of flowers on the dresser may seem to multiply and sway gently as if caught in an invisible breeze. Shadows cast by the window curtains might morph into fleeting shapes that dance across the walls, resembling figures from distant memories." -->


<!-- I ask it to describe its own hallucinations.  -->

<!-- >"Strange creatures emerge from the shadows, their forms blending seamlessly with the landscape yet possessing an otherworldly quality. A unicorn with opalescent fur and shimmering horns grazes peacefully in the meadow, its eyes reflecting the myriad colors of the twilight sky. Ethereal butterflies flit through the air, leaving trails of sparkling dust in their wake. [...] This AI hallucination serves as a reminder of the boundless potential of artificial intelligence to transcend the confines of traditional artistic expression, offering glimpses into worlds both familiar and fantastical" -->
...
<!-- >"A willow and no window, a wide place stranger, a wideness makes an active center." [^Stein] -->
...
<!-- [You can only pull them apart from a single secret side.] Handcarved wooden boxes (they don't make them like they used to) -->
...
<!-- <h1 class='no_toc'>Codes for (Un)Living</h1> -->
...
I think you've noticed this. You take a normal thing, like writing down the date, and you make it large, you make it weird. Art works best when I'm as uncomfortable as possible. To speak to myself with compassion, I had to make an artificial voice that sounded like an uncanny version of me, using other people's words, being kinder than I was capable of at the time. I wanted these repeated transmissions to remap the pathways, rewire the circuits, rewrite the protocols I was trying to unlearn — that inner voice was always someone else's voice anyway.  
...
'Unalive' rewrites unspeakable death to avoid censorship by platforms. Platforms do not read for context clues. They cannot distinguish between deaths to discuss and deaths to erase. They cannot distinguish between queer sexuality and pornography, although they do claim to be able to distinguish between a male nipple and a female nipple, even though gender is not real. Still we must spell out new stuttering formulations to con these 'sophisticated' systems by hovering in the redacted neither-and. 
...
*"Persevering face emoji. Persevering face emoji. Persevering face emoji. Persevering face emoji"*
