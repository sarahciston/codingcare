...
# \emoji{robot} Critical AI & creative–critical coding need each other 

>"I’m stuck here inputting and outputting the data of a story I can't change."

>–Italo Calvino "The Burning of the Abominable House" [-@calvinoNumbersDarkOther1976]
...
## \emoji{bumblebee} Critical AI must be intersectional
...
[^sn-Flusser]: "[Writing] has nothing to do with constructing. It is, on the contrary, a taking away, a de-structing. It is, both structurally and historically, closer to sculpture than to architecture. It is a gesture of making holes, of digging, of perforating. A penetrating gesture. To write is to in-scribe, to penetrate a surface," [CITE]
