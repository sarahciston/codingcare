...
Thinking through technology with a TechnoCraft lens opens more points of reference for addressing complexity and complex systems that prexist the emergent techonlogies we are encountering now. It reminds us that we can slip between scales to to find apt materials and metaphors for grappling with the complexity of systems more approachably and sustainably. Movements across scales, and finding the spaces between and resistances to scale, are also useful explorations. What gets lost in the increase, and what is gained (to whose benefit) as we move either direction? 
